    ...
    <LinearGradient colors={['#0d47a1','#1976d2','#42a5f5']} style={{flex:1}} start={{x:0,y:0}} end={{x:1,y:1}}>
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        <View style={styles.headerContainer}>
          ...
          <Text style={styles.title}>ערוך פרופיל מאמן</Text>
          <Text style={styles.subtitle}>חדד את הפרטים שלך כדי להדגיש טוב יותר את המומחיות שלך</Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <TextInput
            ...
            placeholder="תאר את סגנון האימון שלך... (לפחות 20 תווים)"
            placeholderTextColor="#90a4ae"
            multiline
            numberOfLines={4}
          />
